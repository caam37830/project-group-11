...
time_plot(pop, 3, 1/(nrow*ncol), 0.1, 365, 0, 0, 0.2, 0.7, dir_path+'/doc/final/figures/no_mask.png')

pop = new_pop(15, nrow, ncol)
time_plot(pop, 3, 1/(nrow*ncol), 0.1, 365, 0.1, 0.05, 0.2, 0.7, dir_path+'/doc/final/figures/mask1.png')

pop = new_pop(15, nrow, ncol)
masked_pop = update_masks(pop, 0.2, 0.7, 0.5, 0)
time_plot(masked_pop, 3, 1/(nrow*ncol), 0.1, 365, 0.1, 0.05, 0.2, 0.7, dir_path+'/doc/final/figures/mask2.png')
