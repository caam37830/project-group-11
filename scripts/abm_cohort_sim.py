...
pop = new_pop(5, 100, 100)
time_plot(pop, 3, 0.0001, .1, 365, m=0,u=0,infectivity=0,risk=0, save_path='../doc/final/figures/neigh1.png')
pop = new_pop(5, 100, 100)
time_plot(pop, 3, 0.01, .1, 365, m=0,u=0,infectivity=0,risk=0, save_path='../doc/final/figures/neigh2.png')
pop = new_pop(5, 100, 100)
time_plot(pop, 3, 0.3, .1, 365, m=0,u=0,infectivity=0,risk=0, save_path='../doc/final/figures/neigh3.png')
